    ...
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7">
              ...
              >
                Thorough Medical Audit Expertise
              </h1>
              ...
              >
                Medical Audits for Compliance & Confidence
              </h2>

              <p style={{ fontSize: "1.1rem", lineHeight: 1.8 }}>
                Identify Risks. Recover Revenue. Ensure Compliance. Our billing
                and claims auditors provide detailed reviews to uncover
                compliance gaps, billing issues, and hidden revenue
                opportunities. Strengthen your practice with actionable audit
                findings that maximize reimbursement and improve regulatory
                confidence.
              </p>
      ...
      <section style={{ padding: "60px 0", background: "#fff" }}>
        <div className="container">
          ...
          <p className="text-center mb-5">
            Each year billions are lost due to billing errors, compliance
            failures, and missed revenue opportunities. Our audits uncover
            hidden issues before they become expensive problems.
          </p>

          <div className="row g-4">
            {[
              {
                title: "Billing Errors & Denials",
                desc: "Unidentified claim processing errors lead to denials, payment delays, and compliance risks.",
                impact:
                  "Impact: Bills worth thousands contain errors up to 80%.",
              },
              {
                title: "Processing Delays",
                desc: "Manual inefficiencies slow claim turnaround and hurt cash flow.",
                impact:
                  "Impact: 3–7 day delays can extend payments by 30+ days.",
              },
              {
                title: "Revenue Leakage & Recovery",
                desc: "Missed charges leave thousands of dollars uncollected every month.",
                impact:
                  "Impact: Practices miss 5–10% of potential revenue.",
              },
              {
                title: "Compliance & Audit Exposure",
                desc: "Poor billing and records expose practices to audits and fraud claims.",
                impact:
                  "Impact: Non-compliant practices face severe penalties.",
              },
              {
                title: "Lack of Special Audit Skills",
                desc: "Generic audits miss specialty-specific billing issues.",
                impact:
                  "Impact: Specialty complexity requires expert auditors.",
              },
              {
                title: "Constant Regulatory Changes",
                desc: "Annual code and payer changes require ongoing updates.",
                impact:
                  "Impact: Thousands of yearly code changes require training.",
              },
            ].map((item, index) => (
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0" }}>
        <div className="container">
          ...
          <p className="text-center mb-5">
            Our audits uncover issues and propose solutions to recover revenue
          ...
          <div className="row g-4">
            {[
              ...
              {
                title: "Specialty-Specific Audits",
                points: [
                  "Orthopedic billing review",
                  "E&M audit support",
                  "Surgical billing review",
                  "Radiology/Pathology audit",
                ],
              },
            ].map((service, i) => (
      ...
      <section style={{ padding: "60px 0", background: "#fff" }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-5">
            Full Spectrum Audit Services with Expert Precision
          </h2>
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0" }}>
        <div className="container text-center">
          ...
          >
            "Audit revealed severe billing issues which we were unaware of. The
            stepwise recommendations helped us recover over $200K in additional
            revenue within the first year."
          </blockquote>
          <h4 style={{ marginTop: "20px", fontWeight: 700 }}>
            Practice Administrator: Dr. Sandra Mitchell
          </h4>
        </div>
      </section>
