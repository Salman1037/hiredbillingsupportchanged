    ...
    <>
        ...
        >
          <div className="row align-items-start">
            <div className="col-md-7">
              ...
              >
                Prevent Errors. Standardize Outcomes. Drive Continuous
                Improvement.
              </h2>
              ...
              >
                Our Quality Assurance experts undertake systematic reviews,
                KPI-based reviews, and corrective action frameworks to enhance
                uniformity, minimize defects, and reinforce operational
      ...
      <section style={{ background: "#fff", padding: "60px 0" }}>
        <div className="container">
          ...
          >
            Poor quality, inconsistencies in processes, and repetitive mistakes
            decrease performance and increase risk. Our quality assurance system
            assists you in detecting problems at the earliest stage, repairing
            root causes, and creating repeatable high-quality operations.
          </p>

          <div className="row" style={{ gap: 24, justifyContent: "center" }}>
            {[
              [
                "Quality Variance Among Teams",
                "Working on different standards by various teams leads to inconsistency and unnecessary reworking.",
                "Less consistency and more effort in correction.",
              ],
              [
                "Manual QA Workflows",
                "QA based on spreadsheets is slow to detect and respond to issues and quality management is more difficult to scale.",
                "Reduced promptness in issue resolution and improvements.",
              ],
              [
                "Recurring Quality Defects",
                "Unaddressed root causes lead to recurrence of the quality problems and strains operations.",
                "Continuing defects and quantifiable productivity loss.",
              ],
              [
                "Insufficient QA Governance",
                "In the absence of ownership, review cadence, and escalation pathways, quality programs do not have a life force.",
                "Greater number of critical incidents and reduced accountability.",
              ],
              [
                "Limited Training & Calibration",
                "QA calibration and training must be performed regularly to teams to facilitate uniform standards across time.",
                "Varying performance and higher error rates.",
              ],
              [
                "Continuous Improvement Loop",
                "Quality programs should have periodic feedback loops to ensure measurement of outcomes and maintain long-term improvement.",
                "Sluggish progress and recurring process breakdowns.",
              ],
            ].map((item, index) => (
              <div
                key={index}
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0" }}>
        <div className="container">
          ...
          >
            Reliable & Robust QA Capabilities
          </h2>
          ...
          >
            Our QA services enhance quality assurance, risk mitigation, and
            operational performance through quality checks and governance
            frameworks.
          </p>
            ...
            {[
              ...
              },
              {
                ...
                points: [
                  ...
                  "Execution consistency reviews",
                ],
              },
              {
                title: "Quality Monitoring & Alerts",
                points: [
              ...
              },
              {
                ...
                points: [
                  ...
                  "Owner assignment",
                  "Milestone tracking",
                  "Checks of closure effectiveness",
                ],
              },
            ].map((service, index) => (
              <div
              ...
              >
                <h3 style={{ fontWeight: 800 }}>{service.title}</h3>
      ...
      <section style={{ background: "#fff", padding: "50px 0" }}>
        ...
        >
          ...
          >
            "HBS made our quality program a lot more transparent, our issues are
            solved much more rapidly, and the level of improvement is measurable
            in all teams."
          </blockquote>

          <div style={{ marginTop: 20, fontWeight: 700 }}>
            Karen Holt, Quality Operations Director
          </div>
        </div>
      </section>
