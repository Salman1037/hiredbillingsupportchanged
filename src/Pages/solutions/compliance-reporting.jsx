...
const ComplianceReporting = () => {
  ...
  return (
    <>
          ...
          <div className="row align-items-start">
            <div className="col-md-7">
              <h1 style={{ fontSize: "2.8rem", fontWeight: 900, marginBottom: 18 }}>
                Intelligent Compliance Reporting with Full Risk Visibility
              </h1>
              <h2 style={{ fontSize: "1.45rem", fontWeight: 700, marginBottom: 18, color: "#e0f2fe" }}>
                Standardize Reporting. Reduce Risk. Stay Audit-Ready.
              </h2>
              <p style={{ fontSize: "1.1rem", lineHeight: 1.8, marginBottom: 32 }}>
                Our compliance reporting experts create precise, ready-to-file reports that have transparent metrics, documented records, and automatic alerts. Enhance control, minimize audit risk and ensure your organization is constantly in compliance.
              </p>
              <button
                style={{
                  background: "#5CBDAA",
      ...
      <section style={{ background: "#fff", padding: "60px 0 40px" }}>
        <div className="container">
          <h2 style={{ textAlign: "center", fontWeight: 900, fontSize: "2.2rem", marginBottom: 12 }}>
            Navigating Compliance Reporting Challenges
          </h2>
          <p style={{ textAlign: "center", color: "#444", maxWidth: 760, margin: "0 auto 38px" }}>
            Incomplete information, a manual reporting system, and deadlines contribute to the risk of compliance. Our team consolidates reporting, and enhances audit preparedness in your organization.
          </p>
          <div className="row" style={{ display: "flex", justifyContent: "center", gap: 24, flexWrap: "wrap" }}>
            {[
              ["Data Silos Within Teams", "The data of compliance in disconnected systems does not allow quick and precise reporting and tracking of issues.", "Risk exposure that is not addressed."],
              ["No Centralized Tracking", "Unless tracked centrally, open compliance tasks and deadlines are easily overlooked.", "Lost deadlines and unnecessary compliance loopholes."],
              ["Inaccurate Report Submissions", "Rejections, resubmissions, and delays are caused by inconsistent formats and data quality issues.", "Reworks and lack of operational efficiency."],
              ["Recurring Compliance Findings", "Unless organized corrective action and repetitive trend analysis are undertaken, root causes cannot be resolved.", "Repeat findings bring more regulation."],
              ["Manual Workload Burden", "Instead of addressing high-risk compliance issues, teams use too much time in manual compilation of reports.", "Increased administration expenses and burnout of teams."],
              ["Limited Leadership Visibility", "Lack of dashboards and KPIs means that leaders will be unable to prioritize the remediation or monitor compliance performance.", "Reduced speed of decision-making and poor risk management."],
            ].map((item, index) => (
              <div key={index} className="col-12 col-md-6 col-lg-4" style={{ background: "#fff", borderRadius: 18, boxShadow: "0 2px 12px rgba(0,0,0,0.06)", padding: "32px 24px", minHeight: 260, border: "1px solid #f3f4f6" }}>
                <h3 style={{ fontWeight: 800, fontSize: "1.15rem", marginBottom: 10 }}>{item[0]}</h3>
                <p style={{ color: "#444", marginBottom: 18 }}>{item[1]}</p>
                <div style={{ background: "#fee2e2", padding: "8px 12px", borderRadius: 8 }}>
                  <b>Impact:</b> {item[2]}
                </div>
              </div>
            ))}
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0 40px" }}>
        <div className="container">
          <h2 style={{ textAlign: "center", fontWeight: 900, fontSize: "2.2rem", marginBottom: 12 }}>
            Reliable Compliance Reporting Solutions
          </h2>
          <p style={{ textAlign: "center", color: "#444", maxWidth: 760, margin: "0 auto 38px" }}>
            Our end to end compliance reporting services enhance accuracy, accountability and audit preparedness throughout your organization.
          </p>
          {/* Keep your existing solution cards here exactly as before */}
        </div>
      </section>
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0 40px" }}>
        <div className="container">
          ...
          <p style={{ textAlign: "center", color: "#444", maxWidth: 760, margin: "0 auto 38px" }}>
            All workflow to be accurate, accountable and constantly compliant.
          </p>
          {/* Keep your existing capability cards here exactly as before */}
        </div>
      </section>

      <section style={{ background: "#fff", padding: "48px 0", display: "flex", justifyContent: "center" }}>
        <div style={{ maxWidth: 700, width: "100%", boxShadow: "0 4px 24px rgba(0,0,0,0.08)", padding: "40px 32px", borderRadius: 16, textAlign: "center" }}>
          <blockquote style={{ fontSize: "1.2rem", fontStyle: "italic", lineHeight: 1.7 }}>
            “When we joined forces with HBS, our compliance reporting took a new shape. Now we turn in on time, monitor risks proactively and are completely prepared to any audit.”
          </blockquote>
          <div style={{ fontWeight: 700, marginTop: 20 }}>Melissa Grant, Compliance Director</div>
        </div>
      </section>

      <section style={{ background: "linear-gradient(135deg, #0f172a, #1e293b)", padding: "70px 0", color: "#fff", textAlign: "center" }}>
        <div className="container" style={{ maxWidth: 900 }}>
          <h2 style={{ fontSize: "2.2rem", fontWeight: 800, marginBottom: 18 }}>
            Stay Ahead with Healthcare Billing Insights
          </h2>
          <p style={{ fontSize: "1.08rem", lineHeight: 1.8, color: "#d1d5db", maxWidth: 700, margin: "0 auto 30px" }}>
            Stay informed of the most recent changes in medical billing laws, industry best practices, and strategies to maximize revenues in your inbox.
          </p>
          <button
            onClick={() => navigate("/contact")}
            style={{
