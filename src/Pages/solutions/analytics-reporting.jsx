    ...
    <>
        ...
        <div className="container" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 16px" }}>
          <div className="row align-items-start">
            <div className="col-md-7">
              ...
              >
                Reporting Challenges Simplified
              </h2>
              <p
                style={{
                  fontSize: "1.18rem",
              ...
              >
                Create Decisions out of Data. Drive Performance. Maximize Revenue. Our analytics team can assist you in consolidating information, automation reporting, and discovering concealed trends. Compete with practice-specific interactive dashboards, predictive insights and performance benchmarks.
              </p>
              <button
                className="btn"
                style={{
      ...
      <section style={{ background: "#fff", padding: "60px 0 40px 0" }}>
        <div className="container">
          ...
          >
            Lack of interconnected data sources and manual operations can cause inaccurate, delayed, and incomplete insights and therefore prevents strategic decision making.
          </p>
          ...
          <div className="row" style={{ display: "flex", justifyContent: "center", gap: 24 }}>
            ...
            >
              <h3 style={{ fontWeight: 800, fontSize: "1.15rem", marginBottom: 10, color: "#0f3f3a" }}>
                Fragmented Data Silos
              </h3>
              <p style={{ color: "#444", fontSize: "1.01rem", marginBottom: 18 }}>
                The fact that data is distributed in EHRs, billing systems, and other systems makes it impossible to have a single view of performance.
              </p>
              <div
                style={{
                  background: "#fee2e2",
            ...
            >
              ...
              <p style={{ color: "#444", fontSize: "1.01rem", marginBottom: 18 }}>
                Employees use man hours to compile the spread sheets manually with mistakes and old data.
              </p>
              <div
                style={{
                  background: "#fef9c3",
              ...
              >
                <b>Impact:</b> Wasted resources, and poor decisions using flawed data.
              </div>
            </div>
            ...
            >
              ...
              <p style={{ color: "#444", fontSize: "1.01rem", marginBottom: 18 }}>
                When the reports are ready, the information is usually outdated, which does not allow making any proactive changes.
              </p>
              <div
                style={{
                  background: "#e0f2fe",
              ...
              >
                <b>Impact:</b> Problems solving rather than strategizing.
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0 40px 0" }}>
        <div className="container">
          ...
          >
            Our services include a full package to transform your unprocessed data into a strategic asset that will be efficient and grow your business.
          </p>
          ...
          <div className="row" style={{ display: "flex", justifyContent: "center", gap: 24 }}>
            ...
            >
              ...
              <p style={{ color: "#444", fontSize: "1.01rem", marginBottom: 18 }}>
                We consolidate your financial, clinical, and operational data into a single place of truth to be able to have trustworthy reporting.
              </p>
              <ul style={{ color: "#059669", fontSize: "0.98rem", paddingLeft: 18, marginBottom: 0 }}>
                <li>EHR & PM system integration</li>
                <li>Data cleansing & normalization</li>
            ...
            >
              ...
              <p style={{ color: "#444", fontSize: "1.01rem", marginBottom: 18 }}>
                Analyze your information using interactive and friendly-to-use charts that can help highlight key performance indicators.
              </p>
              <ul style={{ color: "#059669", fontSize: "0.98rem", paddingLeft: 18, marginBottom: 0 }}>
                <li>Role-based dashboards</li>
                <li>Drill-down capabilities</li>
            ...
            >
              ...
              <p style={{ color: "#444", fontSize: "1.01rem", marginBottom: 18 }}>
                Minimize manual effort and create automated reports and a custom report builder to provide ad-hoc analysis.
              </p>
              <ul style={{ color: "#059669", fontSize: "0.98rem", paddingLeft: 18, marginBottom: 0 }}>
                <li>Scheduled report delivery</li>
                <li>Custom report templates</li>
