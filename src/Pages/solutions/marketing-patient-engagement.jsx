...
const MarketingServiceCards = [
  {
    ...
    title: "Patient Engagement Solutions",
    bullets: [
      "Development of the patient outreach and engagement strategy",
      "Follow-up campaigns and appointment reminders",
      "Patient education and awareness programs",
      "Re-engagement of missed or inactive patients",
      "HIPAA-compliant communication workflows",
      "Multi-channel interaction (digital touchpoints, phone, email)",
    ],
  },
  {
    icon: <FaDesktop className="text-primary fs-3 mb-2" />,
    title: "Online Advertising in Healthcare",
    bullets: [
      "Practice-focused digital marketing strategy",
      "Paid online advertising (Google Ads, social media ads)",
      "Website traffic optimization and lead generation",
      "Service landing pages built for conversion",
      "Performance tracking and campaign optimization",
    ],
  },
  {
    ...
    bullets: [
      "HIPAA-compliant email campaign setup",
      "Educational outreach and patient newsletters",
      "Referral and provider outreach campaigns",
  ...
  },
  {
    ...
    title: "Website Marketing & Online Presence",
    bullets: [
      "Website content aligned with offered services",
      "SEO-friendly content organization",
      "Patient-acquisition service pages",
      "Website engagement analytics",
      "Continuous visibility and conversion optimization",
    ],
  },
  {
    icon: <FaBullhorn className="text-primary fs-3 mb-2" />,
    title: "Social Media Marketing & Content",
    bullets: [
      "Healthcare brand social media strategy",
      "Content posting and scheduling",
      "Educational and awareness-based posts",
      "Medical-oriented blog writing",
      "Organic growth blogging",
  ...
  },
  {
    ...
    title: "Cold Calling & Outreach Services",
    bullets: [
      "Professional outbound patient calling",
      "Provider, facility, and referral outreach",
      "Appointment scheduling and inquiry handling",
      "Scripted, professional, compliant communication",
      "Tailored campaigns based on client goals",
    ],
  },
  {
    icon: <FaSearch className="text-primary fs-3 mb-2" />,
...
const MarketingChallenges = [
  {
    title: "Patient Acquisition Difficulties",
    desc: "In competitive healthcare markets, attracting new patients is difficult. Our marketing solutions help convert potential patients into loyal ones.",
  },
  {
    title: "Limited Marketing Resources",
    desc: "Many healthcare practices lack dedicated marketing personnel. Our team provides expert support without high internal overhead.",
  },
  {
    title: "Compliance Concerns",
    desc: "Healthcare marketing must comply with HIPAA and regulatory requirements. We ensure every campaign stays compliant and effective.",
  },
  {
    title: "Patient Engagement Issues",
    desc: "Reducing no-shows and improving retention are vital. Our engagement strategies strengthen patient relationships.",
  },
  {
    title: "Online Visibility Challenges",
    desc: "Poor online visibility affects patient growth. Our SEO and local marketing improve search rankings and visibility.",
  },
];
...
function MarketingServiceCard({ icon, title, bullets }) {
  return (
    <div className="col-12 col-md-6 col-lg-3 mb-4 d-flex align-items-stretch">
      <div className="card h-100 border-0 shadow-sm p-4" style={{ borderRadius: 16, background: "#f5faff" }}>
        <div className="mb-3" style={{ fontSize: 36, color: "#5CBDAA" }}>{icon}</div>
        <h5 className="fw-bold mb-3">{title}</h5>
        <ul className="list-unstyled mb-0">
          {bullets.map((b, i) => (
            <li key={i} className="mb-2 d-flex">
              <span style={{ color: "#5CBDAA", marginRight: 8 }}>•</span>{b}
            </li>
          ))}
        </ul>
      </div>
...
function CardItem({ icon, title, desc }) {
  return (
    <div className="col-md-3" style={{ background: "#f9fafd", borderRadius: 14, padding: 22, margin: 8, minWidth: 220 }}>
      <div style={{ fontSize: "2rem", color: "#5CBDAA", marginBottom: 10 }}>{icon}</div>
  ...
  return (
    <>
      ...
      >
        <div className="container">
          <div className="col-md-6">
            <h1 className="fw-bold" style={{ fontSize: 48 }}>Marketing & Patient Engagement Solutions</h1>
            <div style={{ fontSize: 22, fontWeight: 600, marginBottom: 15 }}>
              Compliant | Data-Driven | Growth-Focused
            </div>
            <p style={{ fontSize: 20, lineHeight: 1.8 }}>
              We help healthcare providers, practices, and facilities develop stronger patient relationships and achieve sustainable growth through compliant, data-driven marketing and engagement strategies.
            </p>
            <button className="btn" style={{ background: "#5CBDAA", color: "#fff" }} onClick={() => navigate("/contact")}>Get Started</button>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0" }}>
        <div className="container text-center">
          <h2 className="fw-bold mb-4">Our Strategic Approach</h2>
          <p>Our marketing strategy can bring quantifiable outcomes whether you are a single care provider, middle-sized practice, or an expanding healthcare organization.</p>
        </div>
      </section>
      ...
      <section style={{ padding: "60px 0" }}>
        <div className="container">
          ...
          <div className="row">
            {MarketingServiceCards.map((card, idx) => <MarketingServiceCard key={idx} {...card} />)}
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0" }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-5">Flexible Engagement & Pricing</h2>
          <div className="row">
            <div className="col-md-3"><CardItem icon={<FaUsers />} title="Dedicated Marketing Specialist" desc="Full-time or part-time support dedicated to your practice." /></div>
            <div className="col-md-3"><CardItem icon={<FaRocket />} title="Campaign-Based Support" desc="Ideal for seasonal or one-time growth initiatives." /></div>
            <div className="col-md-3"><CardItem icon={<FaCheckCircle />} title="Service-Specific" desc="Focused support for SEO, websites, or social media only." /></div>
            <div className="col-md-3"><CardItem icon={<FaChartLine />} title="Pricing Factors" desc="Based on scope, reach, complexity, and duration." /></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "60px 0" }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-5">The HBS Advantage</h2>
          <div className="row justify-content-center">
            <CardItem icon={<FaShieldAlt />} title="HIPAA-Compliant" desc="Every workflow follows healthcare compliance standards." />
            <CardItem icon={<FaChartLine />} title="Results-Driven" desc="Measurable growth and patient engagement improvements." />
            <CardItem icon={<FaSyncAlt />} title="Scalable & Flexible" desc="Solutions that grow with your organization." />
            <CardItem icon={<FaComments />} title="Dedicated Support" desc="Consistent reporting and campaign optimization." />
          </div>
        </div>
      </section>

      <section style={{ background: "#5DC0A7", padding: "70px 0", color: "#fff" }}>
        <div className="container text-center">
          <h2 className="fw-bold mb-4">Who We Serve</h2>
          <p>Independent Practices, Multi-Specialty Clinics, Physical Therapy Centers, Rehabilitation Centers, Behavioral Health Practices, Specialty Providers, Healthcare Facilities.</p>
        </div>
      </section>

      <section style={{ padding: "70px 0" }}>
        <div className="container">
          <h2 className="fw-bold mb-4">Challenges We Solve</h2>
          {MarketingChallenges.map((item, idx) => (
      ...
      <section style={{ background: "#f8fafc", padding: "60px 0" }}>
        <div className="container text-center">
          <h2 className="fw-bold mb-3">Healthcare Insights & Updates</h2>
          <p>Stay informed on the latest changes in medical billing laws, healthcare marketing best practices, and revenue optimization strategies directly in your inbox.</p>
          <div style={{ maxWidth: 500, margin: "0 auto", display: "flex", gap: 12 }}>
            <input type="email" placeholder="Type in your email address" className="form-control" />
            <button className="btn" style={{ background: "#5CBDAA", color: "#fff" }}>Subscribe</button>
          </div>
        </div>
      </section>

      <section style={{ background: "#fff", padding: "48px 0", display: "flex", justifyContent: "center" }}>
        <div style={{ maxWidth: 700, width: "100%", borderRadius: 16, boxShadow: "0 4px 24px rgba(0,0,0,0.08)", padding: 40, textAlign: "center" }}>
          <blockquote style={{ fontSize: "1.25rem", fontStyle: "italic" }}>
            "Working with HBS has made a difference. The staff is professional, responsive, and has simplified the process of billing our operations."
          </blockquote>
          <div style={{ fontWeight: 700 }}>Herma Thompson PMHNP-BC</div>
          <div>Nurse Practitioner - Psych/Mental Health</div>
        </div>
      </section>
    </>
  );
